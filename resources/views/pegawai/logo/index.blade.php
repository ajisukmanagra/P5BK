        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <a href="{{route('pegawai/logo/create')}}" class="btn btn-primary mb-4"><i class="fas fa-plus-circle"></i> Tambah Galeri</a>&nbsp;
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered" id="guru">
                          ...
                          @foreach ($logo as $no => $logo)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ asset('/image/'.$logo->logo)}}" style="font-size: 12px;" class="btn btn-success btn-sm">
                                            <i class="fas fa-camera"></i> Lihat Gambar
                                        </a> 
                                    </td>
                                    <td>
                                        <a href="{{ asset('/image/'.$logo->icon)}}" style="font-size: 12px;" class="btn btn-success btn-sm">
                                            <i class="fas fa-camera"></i> Lihat Gambar
                                        </a> 
                                    </td>
                                    <td>{{ $logo->nama}}</td>
